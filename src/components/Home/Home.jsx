...
const Home = () => {
    ...
    useEffect(() => {
        homeService.useAgeEffect(ageRef.current);
    });
    ...
    return (
        <>
            ...
            >
                ...
                <section className="snap-center hero min-h-screen bg-cyan-300 flex flex-col gap-10 items-center justify-center">
                    <div className="text-center">
                        <h1
                            className="typewrite text-4xl font-bold text-cyan-800 mt-52 select-none"
                            ref={typewriteRef}
                        ></h1>
                    </div>
                ...
                <section
                    ref={secondSection}
                    className="snap-center about-me min-h-screen bg-orange-300 flex p-20 justify-between relative"
                >
                ...
                <section
                    ref={thirdSection}
                    className="snap-center motives min-h-screen flex p-20 bg-emerald-300/80 justify-end relative overflow-hidden"
                >
                    <div className="flex flex-col w-1/2">
                        ...
                        <p className="font-semibold select-none text-emerald-800/80 break-words mt-16 text-lg">
                            I love technology, logic and maths. What I am even
                            more passionate about is uncovering how things work
                            beneath the surface. I believe that&apos;s due to my
                            natural curiosity. I love to dive into difficult
                            problems with no other goal but to learn. Yeah,
                            sometimes my brain starts to hurt from all of the
                            &quot;amazing&quot; complexity and sometimes I
                            realize how stupid I am... but once I solve the
                            problem all of that is no longer important. All of a
                            sudden all the hours spent have no longer gone to
                            waste and I love that feeling. The feeling of
                            overcoming an obstacle.
                        </p>
                        <p className="font-semibold select-none text-emerald-800/80 break-words mt-16 text-lg">
                            That brings us to ICT. Full of problems to solve,
                            full of logic and while not as much, still a decent
                            amount of maths.
                        </p>
                        <div className="flex justify-center mt-32 select-none text-emerald-300/80 font-bold gap-10">
                            ...
                            <Link
                                ...
                                className="cursor-pointer bg-emerald-800/80 p-4 rounded-full hover:-translate-y-1 transition-transform"
                            >
                                <i className="fa-brands fa-github"></i> My
                                Github
                            </Link>
                        </div>
                    </div>
