...
const Home = () => {
    ...
    return (
        <div>
            <section className="hero min-h-screen bg-cyan-300/80 flex flex-col gap-10 items-center justify-center ">
                <div className="text-center">
                    <h1 className="typewrite text-4xl font-bold text-cyan-800 mt-48 select-none" ref={typewriteRef}></h1>
                </div>
            ...
            <section className="about-me min-h-screen bg-orange-300/80 flex p-20 justify-between relative">
                ...
                <img
                    ...
                    className="mr-40 select-none max-w-md"
                    alt=""
                ></img>
                <button
                    id="scrollto-bottom"
            ...
            <section className="motives min-h-screen flex p-20 bg-emerald-300/80 justify-end relative overflow-hidden">
                <div className="flex flex-col w-1/2">
                    ...
                    <div className="flex justify-center mt-32 select-none text-emerald-300/80 font-bold gap-10">
                        ...
                        <a
                            href="https://github.com/kebabzter"
                            className="cursor-pointer bg-emerald-800/80 p-4 rounded-full hover:-translate-y-1 transition-transform"
                        >
                ...
                <div className="question-marks select-none">
                    ...
                    <p className="absolute right-40 top-40 text-gigaxl font-semibold text-emerald-800/80 animate-spin-slowerer -z-10">
                        ?
                    </p>
